...
export const updateProductSchema=z.object({
    ...
    productName:z.string().min(2,"Product name must contain at least 2 characters").max(50).optional(),
    productDescription:z.string().min(10, "Description must contain at least 10 characters").optional(),
    productImageUrls:z.array(z.url()).optional(),
